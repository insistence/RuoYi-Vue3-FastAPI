...
- `../ruoyi-fastapi-frontend/tests/plugins/{plugin_id}/`: frontend node tests for this plugin.
...
cd ../ruoyi-fastapi-frontend && node tests/plugins/{plugin_id}/pluginView.test.js
...
```text
ruoyi-fastapi-frontend/plugins/{plugin_id}/views/index.vue
```
"""
