...
class LockConstant:
    ...
    PLUGIN_STARTUP_READY_KEY = 'plugin:startup:ready'
    PLUGIN_STARTUP_READY_EXPIRE_SECONDS = 2592000
    PLUGIN_STARTUP_FAILED_EXPIRE_SECONDS = 60
    PLUGIN_STARTUP_READY_WAIT_TIMEOUT_SECONDS = 1800
    PLUGIN_STARTUP_READY_WAIT_INTERVAL_SECONDS = 1
    PLUGIN_LIFECYCLE_LOCK_PREFIX = 'plugin:lifecycle:lock'
