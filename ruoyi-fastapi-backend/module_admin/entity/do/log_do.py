from sqlalchemy import CHAR, BigInteger, Column, Index, Integer, String
...
class SysLogininfor(Base):
    ...
    login_time = Column(DbUtcDateTime(), nullable=True, default=TimezoneUtil.utc_now, comment='访问时间')
...
class SysOperLog(Base):
    ...
    oper_time = Column(DbUtcDateTime(), nullable=True, default=TimezoneUtil.utc_now, comment='操作时间')
